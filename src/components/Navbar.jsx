    ...
    <div className='left-0 top-0 z-10 w-full absolute'>
        ...
        <div className={`md:hidden ${showMobileMenu ?'fixed w-full':'w-0 h-0'}  bottom-0 top-0 right-0 left-0  overflow-hidden bg-white transition-all`}>
          ...
          <ul className='flex flex-col items-center mt-5 mx-4 text-lg font-medium'>
                <a href="#header" className='cursor-pointer px-3 hover:text-gray-400'>Home</a>
                <a href="#about" className='cursor-pointer px-3 hover:text-gray-400'>About</a>
                <a href="#projects" className='cursor-pointer px-3 hover:text-gray-400'>Projects</a>
                <a href="#testtymonials" className='cursor-pointer px-3 hover:text-gray-400'>Testtymonials</a>
          </ul>
        </div>
